...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytask-environment-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12127&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytask-environment-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytask-environment` can be installed with:

```
conda install pytask-environment
```

It is possible to list all of the versions of `pytask-environment` available on your platform with:
